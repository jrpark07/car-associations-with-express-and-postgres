  ...
  static async seed() {
    try {
      ...
      for(let i=0; i < carMakes.length; i++) {
        ...
        const queryString = "INSERT INTO car_makes (name) VALUES ($1);"
        await pool.query(queryString, [carMake.name])
      }
      ...
      for(let i=0; i < carModels.length; i++) {
        ...
        const queryString = `INSERT INTO car_models (name, car_make_id) VALUES ($1, $2);`
        await pool.query(queryString, [carModel.name, carModel.carMake.id])
      }
